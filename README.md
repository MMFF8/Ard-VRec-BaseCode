...
CG=Y;
```
where X = 0x12, 0x13, 0x14, or 0x15, depending on what subgroup you're going to use (0x12 = subgroup 1, 0x13 = subgroup 2, etc.)
where Y = the number of the group to be used (group = subgroup number + 1)
<br>
&nbsp; ex.
